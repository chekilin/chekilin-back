...
(
    ...
    `created`  DATETIME(0) NOT NULL DEFAULT '1000-01-01 00:00:00' COMMENT 'レコード作成日時',
    `modified` DATETIME(0) NOT NULL DEFAULT '1000-01-01 00:00:00' COMMENT 'レコード修正日時',
    PRIMARY KEY (`id`),
...
(
    ...
    `created`  DATETIME(6) NOT NULL DEFAULT '1000-01-01 00:00:00' COMMENT 'レコード作成日時',
    `modified` DATETIME(6) NOT NULL DEFAULT '1000-01-01 00:00:00' COMMENT 'レコード修正日時',
    PRIMARY KEY (`id`),
